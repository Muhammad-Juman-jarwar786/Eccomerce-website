...
const SingleProduct = () => {
  ...
  return (
    <>
      {productToShow.map((product: any, index: any) => (
        <div key={index} className="pt-40 bg-slate-50 md:flex">
          <div className="ml-3 mr-3 lg:mr-10 lg:w-[180vw]">
            <div className="w-full ">
              <img className="" src={mainImage || product.img} alt="" />
            </div>
          ...
          <div className="font-bold tracking-wider text-center lg:text-left mt-10">
            ...
            <p className="mt-2 text-sm md:text-lg lg:text-xl  text-justify ml-6 mr-6 lg:mr-16 lg:ml-1 text-slate-500 font-semibold mb-40">
              ...
              consectetur adipisicing elit. Expedita velit fugiat amet,
              voluptate sint et ducimus iusto natus quisquam dolores iste,
              magnam necessitatibus eaque nam voluptatem praesentium obcaecati
              temporibus eos?
            </p>
          </div>
        </div>
